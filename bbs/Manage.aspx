<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" ValidateRequest="false"  CodeFile="Manage.aspx.cs" Inherits="bbs_List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table width="99%" height="100%" align="center" style="border:2px solid #D6F2FE;">
        <tr><td height="28" style="background-color:#D6F2FE;">
            <b style="color:#4F98C6; font-size:12px;vertical-align:middle;">&nbsp;&nbsp;管理话题信息</b>
            </td></tr>
            <tr>
                <td>
 ...
 <table style="width:100%;">
    ...
    <tr>
        ...
        <Columns>       
            ...
            <asp:HyperLinkField   DataNavigateUrlFormatString="View.aspx?id={0}" DataNavigateUrlFields="bid" HeaderText="详情" Text="详情"  >
                <ItemStyle Width="50px" />
            </asp:HyperLinkField>
            <asp:HyperLinkField DataNavigateUrlFormatString="Modify.aspx?id={0}"  DataNavigateUrlFields="bid" HeaderText="修改" Text="修改"  >                
                <ItemStyle Width="50px" />
            </asp:HyperLinkField>   
        </Columns>
