<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" ValidateRequest="false"  CodeFile="Manage - 复制.aspx.cs" Inherits="sports_List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table width="99%" height="100%" align="center" style="border:2px solid #D6F2FE;">
        <tr><td height="28" style="background-color:#D6F2FE;">
            <b style="color:#4F98C6; font-size:12px;vertical-align:middle;">&nbsp;&nbsp;管理日常运动量信息</b>
            </td></tr>
            <tr>
                <td>
 ...
 <table style="width:100%;">
    ...
    <tr>
        ...
        <Columns>       
            ...
            <asp:BoundField HeaderText="日期" DataField="sdate" />
            <asp:BoundField HeaderText="行走步数" DataField="squan" />
